...
public interface MessageService {
    ...
    List<MessageDTO> getMessagesByStatus(MessageSentStatus status);
    Page<MessageDTO> getMessagesByStatus(MessageSentStatus status, Pageable pageable);
    ...
    long countByStatus(MessageSentStatus status);
